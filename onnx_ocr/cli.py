...
def ocr(
    ...
    det_model_dir: str = typer.Option(
        "./models/ppocrv5_server/det/det.onnx", "--det-model", help="检测模型路径"
    ),
    rec_model_dir: str = typer.Option(
        "./models/ppocrv5_server/rec/rec.onnx", "--rec-model", help="识别模型路径"
    ),
